  ...
  return (
    <div className="p-8 max-w-6xl mx-auto w-full">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h2 className="text-2xl font-bold text-text-main mb-1">CircuitRocks Components</h2>
        ...
        <form onSubmit={handleSearch} className="flex gap-2">
          <input 
            ...
            className="bg-bg-panel border border-border-dark rounded-lg px-4 py-2 text-sm focus:outline-none focus:border-primary w-64 text-text-main"
          />
          <button type="submit" className="bg-bg-dark border border-border-dark px-4 py-2 rounded-lg text-sm hover:bg-primary/10 transition-colors text-text-main">Search</button>
        </form>
      </div>
